function circleSelector(containerSelector, selectorSettings, menuItemCallback) {
  try {
    let createLine2 = function() {
      ...
      if (window.innerWidth > breakpoint) {
        activatorMousenter = lookEvent2(
          ...
          () => {
            moveItems2(elementsData, "targetCorner", "animationOut");
          }
        );
        selectorMouseleave = lookEvent2(
          selector,
          //event listener target
          "mouseleave",
          // event
          ...
          // Name of the last animation to run
          () => {
            moveItems2(elementsData, "initElementCorner", "animationIn");
          }
        );
      } else {
        activatorClick = lookEvent2(
          selectorActivator,
          //event listener target
          "click",
          // event
    ...
    }, lookEvent2 = function(element, event, primaryAnimationFlag, secondaryAnimationFlag, primaryFunction) {
      const handler = (e) => {
        e.stopPropagation();
    ...
    }, createPrimaryData2 = function(elements2) {
    ...
    }, calculateCoords2 = function(primaryData2, selector2, elements2) {
      ...
      elements2.forEach((element, i) => {
        ...
        let line = background.children[i] || createLine2();
        result.push({
          element,
          elementCornerX,
          elementCornerY,
      ...
      roundData2(result);
      return result;
    }, roundData2 = function(arrOfObjects) {
      ...
      ;
    }, moveItems2 = function(elementsData2, target, animationName) {
      ...
      function animate() {
        ...
        elementsData2.forEach((obj) => {
          changeCoordinate2(obj, "startX", "elementCornerX", `${target}X`, t, "left");
          changeCoordinate2(obj, "startY", "elementCornerY", `${target}Y`, t, "top");
    ...
    }, changeCoordinate2 = function(obj, startCoord, elementCoord, targetCoord, t, side) {
      let progress;
    ...
    }, createResponseDesign2 = function() {
        ...
        if (currentWidth !== selector.offsetWidth) {
          ...
          timeoutId = setTimeout(() => {
            requestAnimationFrame(() => {
              ...
              elementsData = calculateCoords2(primaryData, selector, elements);
              startCoordsCorrection2(elementsData);
              hideLines2();
              removeListener = setListeners2();
            });
          }, 100);
        }
        ;
      });
    }, startCoordsCorrection2 = function(elementsData2) {
      ...
      activator = getActivatorParams2(selectorActivator, minX, minY);
    }, getActivatorParams2 = function(activator2, activatorCornerX, activatorCornerY) {
    ...
    var createLine = createLine2, setListeners = setListeners2, lookEvent = lookEvent2, createPrimaryData = createPrimaryData2, calculateCoords = calculateCoords2, roundData = roundData2, moveItems = moveItems2, drawLines = drawLines2, hideLines = hideLines2, changeCoordinate = changeCoordinate2, createResponseDesign = createResponseDesign2, startCoordsCorrection = startCoordsCorrection2, getActivatorParams = getActivatorParams2;
    ...
    setTimeout(() => {
      requestAnimationFrame(() => {
        primaryData = createPrimaryData2(elements);
        elementsData = calculateCoords2(primaryData, selector, elements);
        startCoordsCorrection2(elementsData);
        createResponseDesign2();
      });
    ...
    let removeListener = setListeners2();
    ;
    ;
    ;
    ;
